    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
           if( _context.Department.Any() ||
            ...
            Department d4 = new Department(4, "Book");

            Seller s1 = new Seller(1, "Juliana", "juliana@gmail.com", new DateTime(1986, 3, 18), 2000.00, d1);
            Seller s2 = new Seller(2, "José", "jose@gmail.com", new DateTime(1988, 9, 5), 1850.00, d2);
            Seller s3 = new Seller(3, "Alice", "alice@gmail.com", new DateTime(1988, 8, 29), 1980.00, d3);
            Seller s4 = new Seller(4, "Henrique", "henrique@gmail.com", new DateTime(1986, 1, 5), 2050.00, d4);
            Seller s5 = new Seller(5, "Maria", "maria@gmail.com", new DateTime(1993, 5, 30), 2100.00, d1);
            Seller s6 = new Seller(6, "Antonio", "antonio@gmail.com", new DateTime(1995, 11, 15), 1500.00, d2);
